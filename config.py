...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7758738938:AAFvm8YQbL4-S-CQPskQ1g6JgmjdtcAGXPc")
...
FORCE_SUB_CHANNEL_2 = int(os.environ.get("FORCE_SUB_CHANNEL_2", None))

FORCE_SUB_CHANNEL_3 = int(os.environ.get("FORCE_SUB_CHANNEL_3", None))

FORCE_SUB_CHANNEL_4 = int(os.environ.get("FORCE_SUB_CHANNEL_4", None))
